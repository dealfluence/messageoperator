# Mailroom POC3 — Architectural Context & Patterns

## Core Architecture

Mailroom is an email environment structured around a **FileSystem contract** (Path Jail and Maildir layout) rather than a specific language API. It separates execution into two key parts:
